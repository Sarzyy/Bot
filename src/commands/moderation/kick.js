...
module.exports = {
    ...
    if (targetUserRolePosition >= requestUserRolePostion) {
      await interaction.editReply("You cannot kick that user because they have the same / higher role than you.");
      return;
    }

    if (targetUserRolePosition >= botRolePosition) {
      await interaction.editReply("I cant kick the user because they have the same/higher role than me.");
      return;
    }
    ...
    try {
      ...
      console.log(`There was an error while kicking the user: "${targetUser}", The error: ${error}`)
    }
  },
